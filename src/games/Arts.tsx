...
import { ColorTheoryStudioChallenge } from './arts/ColorTheoryStudioChallenge';
import { RhythmSightReadingChallenge } from './arts/RhythmSightReadingChallenge';
import { BroadwayLeadChallenge } from './arts/BroadwayLeadChallenge';

interface ArtsGameProps {
    challenge: Challenge;
    onComplete: (score: number) => void;
    onExit: () => void;
}

export function ArtsGame({ challenge, onComplete, onExit }: ArtsGameProps) {
    ...
    if (gameState === 'intro') {
        return (
            <div className="min-h-screen bg-gradient-to-br from-purple-50 to-fuchsia-50 flex items-center justify-center p-4">
                <div className="max-w-2xl w-full bg-white rounded-3xl shadow-2xl p-8 max-h-[90vh] overflow-y-auto">
                    ...
                    <div className="bg-purple-50 rounded-2xl p-6 mb-8">
                        ...
                        <ul className="space-y-3 text-gray-700">
                            <li className="flex items-start gap-3">
                                ...
                                <span>Apply real arts & performance industry knowledge</span>
                            </li>
                            <li className="flex items-start gap-3">
                                ...
                                <span>Make creative decisions that serve the audience experience</span>
                            </li>
                            <li className="flex items-start gap-3">
                                ...
                                <span>Learn skills used by professional artists, musicians, and stage managers</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <button
                        ...
                        className="w-full py-4 bg-gradient-to-r from-purple-500 to-fuchsia-500 hover:from-purple-600 hover:to-fuchsia-600 text-white font-bold rounded-xl text-lg transition-all transform hover:scale-105"
                    >
                        Start Challenge
                    </button>
                </div>
    ...
    if (gameState === 'playing') {
        ...
        const challengeType = config?.subType || 'color-theory-studio';
        ...
        return (
            <div className="min-h-screen bg-gradient-to-br from-purple-50 to-fuchsia-50">
                ...
                {(challengeType === 'color-theory-studio') && (
                    <ColorTheoryStudioChallenge onComplete={handleGameComplete} />
                )}
                {(challengeType === 'rhythm-sight-reading') && (
                    <RhythmSightReadingChallenge onComplete={handleGameComplete} />
                )}
                {(challengeType === 'broadway-lead' || challengeType === 'stage-manager-sim') && (
                    <BroadwayLeadChallenge onComplete={handleGameComplete} />
                )}
            </div>
        );
    }
            ...
            <div className="max-w-2xl w-full bg-white rounded-3xl shadow-2xl p-8 text-center">
                <div className="mb-8">
                    ...
                    <p className="text-lg text-gray-700">
                        {score >= 90
                            ? "Standing ovation! You're a true creative professional!"
                            : score >= 70
                ...
                <div className="flex gap-4">
                    ...
                    <button
                        ...
                        className="flex-1 py-3 bg-gradient-to-r from-purple-500 to-fuchsia-500 text-white font-semibold rounded-xl hover:from-purple-600 hover:to-fuchsia-600 transition-colors"
                    >
                        Continue
                    </button>
                </div>
