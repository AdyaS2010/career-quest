      ...
      <div className="min-h-screen bg-gradient-to-br from-orange-50 to-yellow-50 flex items-center justify-center p-4">
        <div className="max-w-2xl w-full bg-white rounded-3xl shadow-2xl p-8">
          ...
          <div className="text-center mb-8">
            <div className="w-28 h-28 bg-gradient-to-br from-orange-500 to-red-500 rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg">
              <span className="text-6xl">👨‍🍳</span>
            </div>
            <h2 className="text-4xl font-bold text-gray-900 mb-2">
              {challenge.title}
            </h2>
            <div className="text-sm text-orange-700 font-semibold mb-3">Experience the life of a chef — cook, plate, and serve under pressure.</div>
            <p className="text-lg text-gray-600 max-w-xl mx-auto">
              {challenge.description}
            </p>

            <div className="mt-6 flex justify-center gap-2">
              <span className="px-3 py-1 bg-orange-100 text-orange-700 rounded-full text-sm">Timing</span>
              <span className="px-3 py-1 bg-amber-100 text-amber-700 rounded-full text-sm">Presentation</span>
              <span className="px-3 py-1 bg-red-100 text-red-700 rounded-full text-sm">Customer Care</span>
            </div>
          </div>
      ...
      <div className="min-h-screen bg-gradient-to-br from-orange-50 to-yellow-50">
        <div className="sticky top-0 z-40 bg-white/90 backdrop-blur-lg shadow-sm">
          <div className="max-w-7xl mx-auto px-4 py-4 flex flex-col sm:flex-row items-center justify-between">
            ...
            <div className="text-sm text-orange-700 font-semibold mt-2 sm:mt-0 sm:mx-auto">Experience the life of a chef — cook, plate, and serve under pressure.</div>
