      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 flex items-center justify-center p-4">
        <div className="max-w-2xl w-full bg-white rounded-3xl shadow-2xl p-8">
          ...
          <div className="text-center mb-8">
            <div className="w-28 h-28 bg-gradient-to-br from-blue-500 to-indigo-500 rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg">
              <span className="text-6xl">⚖️</span>
            </div>
            <h2 className="text-4xl font-bold text-gray-900 mb-2">
              {challenge.title}
            </h2>
            <div className="text-sm text-blue-700 font-semibold mb-3">Defend or prosecute — gather evidence, craft arguments, and persuade a jury.</div>
            <p className="text-lg text-gray-600">
              {challenge.description}
            </p>

            <div className="mt-6 flex justify-center gap-2">
              <span className="px-3 py-1 bg-blue-100 text-blue-700 rounded-full text-sm">Evidence</span>
              <span className="px-3 py-1 bg-indigo-100 text-indigo-700 rounded-full text-sm">Arguments</span>
              <span className="px-3 py-1 bg-sky-100 text-sky-700 rounded-full text-sm">Strategy</span>
            </div>
          </div>
