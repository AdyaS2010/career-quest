      ...
      <div className="min-h-screen bg-gradient-to-br from-purple-50 to-pink-50 flex items-center justify-center p-4">
        <div className="max-w-2xl w-full bg-white rounded-3xl shadow-2xl p-8">
          ...
          <div className="text-center mb-8">
            <div className="w-28 h-28 bg-gradient-to-br from-purple-500 to-pink-500 rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg">
              <span className="text-6xl">📰</span>
            </div>
            <h2 className="text-4xl font-bold text-gray-900 mb-2">
              {challenge.title}
            </h2>
            <div className="text-sm text-purple-700 font-semibold mb-3">Chase the story — investigate, interview, and publish compelling reports.</div>
            <p className="text-lg text-gray-600">
              {challenge.description}
            </p>

            <div className="mt-6 flex justify-center gap-2">
              <span className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-sm">Fact-checking</span>
              <span className="px-3 py-1 bg-pink-100 text-pink-700 rounded-full text-sm">Interviewing</span>
              <span className="px-3 py-1 bg-violet-100 text-violet-700 rounded-full text-sm">Storytelling</span>
            </div>
          </div>
